...
// Create Context object
 export const SoliumFormContext = createContext();

// Provider Component
export const SoliumFormProvider = ({ children }) => {
  ...
  return (
    <SoliumFormContext.Provider value={contextValue}>
      {children}
    </SoliumFormContext.Provider>
  );
};
