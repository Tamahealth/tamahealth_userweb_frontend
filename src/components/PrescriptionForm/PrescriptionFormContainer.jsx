...
const PrescriptionFormContainer = () => {
  ...
  const handleFormSubmit = () => {
    ...
    const formDataFromInputs = {
      ...
      prescriberinstitution: document.querySelector('input[name="prescriberinstitution"]').value,
      phone1: document.querySelector('input[name="phone1"]').value,
      email: document.querySelector('input[name="email"]').value,
       CommissaryNameLast: document.querySelector('input[name="CommissaryNameLast"]').value,
       CommissaryNameFirst: document.querySelector('input[name="CommissaryNameFirst"]').value,
       CommissaryNameMiddle: document.querySelector('input[name="CommissaryNameMiddle"]').value,
